...
template void Randomizer::fillArray<int>(int*, int, int, int, SortingType);
template void Randomizer::fillArray<float>(float*, int, float, float, SortingType);
template void Randomizer::fillArray<double>(double*, int, double, double, SortingType);